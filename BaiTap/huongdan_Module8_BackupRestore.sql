...
TO DISK = 'F:\Backupdb\AdventureWorks2012.bak'   
WITH FORMAT;  
GO  
...
---t4 : database bị xóa 
drop database AdventureWorks2008R2    -- - xóa file .mdf, .ldf, .ndf

---=> kịch bản phục hồi về t1 :
---Restore dựa trên bản full backup
RESTORE DATABASE  AdventureWorks2008R2   
FROM DISK =  'F:\Backupdb\AdventureWorks2012.bak' 
WITH  FILE=1 , replace , RECOVERY ;				--- end			
